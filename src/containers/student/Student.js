        ...
        <div className="col-span-6 bg-gray-100">
          ...
          <div>
            ...
            <div className="flex justify-between">
              <button style={{background: 'rgba(0, 143, 251, 0.85)'}} className="w-56 h-12 text-white text-xl font-semibold rounded-xl ml-3">Посещаемость</button>
              <button style={{background: 'rgba(254, 176, 25, 0.85)'}} className="w-56 h-12 text-white text-xl font-semibold rounded-xl">Экзамен</button>
              <button style={{background: 'rgba(0, 227, 150, 0.85)'}} className="w-56 h-12 text-white text-xl font-semibold rounded-xl mr-3">Домашние задания</button>
            </div>
